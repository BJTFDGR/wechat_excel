package wechat.wechat.wechat_excel;

import android.os.Environment;
import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;
import android.view.View;
import com.excel.excel.ExcelUtils;
import java.io.File;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<wechatdatastore> sample;
    private static String[] title = { "nickname","username","alias" };
    private File file;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i < count; i++) {
            sample.add(new wechatdatastore(nickname.get(i-1),username.get(i-1),alias.get(i-1)));
        }
    }
    ...
    public void exportExcel(View view) {
        ...
        makeDir(file);
        ExcelUtils.initExcel(file.toString() + "/chatbase.xls", title);
        fileName = getSDPath() + "/Record/chatbase.xls";
    ...
    private  ArrayList<ArrayList<String>> getRecordData() {
        ...
        for (int i = 0; i <sample.size(); i++) {
            wechatdatastore student = sample.get(i);
            ArrayList<String> beanList = new ArrayList<String>();
            beanList.add(student.nickname);
            beanList.add(student.username);
            beanList.add(student.alias);
    ...
    private void openWxDb(File dbFile) {
        ...
        try {
            ...
            Cursor c1 = db.rawQuery("select * from rcontact where verifyFlag = 0  and type = 3 limit 20, 9999", null);
            ...
            while (c1.moveToNext()) {
                ...
                username.add(c1.getString(c1.getColumnIndex("username")));
                alias.add(c1.getString(c1.getColumnIndex("alias")));
                nickname.add(c1.getString(c1.getColumnIndex("nickname")));
            }
